...
export namespace ArbitratedEvent {
...
export namespace ArbitratorProposedEvent {
  export type InputTuple = [
    escrowId: BigNumberish,
    arbitrator: AddressLike,
    arbitratorFee: BigNumberish,
...
export interface UnicrowArbitrator extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "arbitrationCalculation"
  ): TypedContractMethod<
    [
      currentSplit: [
        BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "escrowArbitrator"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [
      [string, bigint, boolean, boolean, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "getArbitratorData"
  ): TypedContractMethod<
    [escrowId: BigNumberish],
    [ArbitratorStructOutput],
    "view"
  >;
  getFunction(
    nameOrSignature: "proposeArbitrator"
  ): TypedContractMethod<
    [
      escrowId: BigNumberish,
      arbitrator: AddressLike,
  ...
  getEvent(
    ...
    ArbitratedEvent.InputTuple,
    ArbitratedEvent.OutputTuple,
    ArbitratedEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "ArbitratorProposed"
  ): TypedContractEvent<
    ArbitratorProposedEvent.InputTuple,
    ArbitratorProposedEvent.OutputTuple,
    ArbitratorProposedEvent.OutputObject
  >;

  filters: {
    "Arbitrated(uint256,tuple,uint256,uint256[5])": TypedContractEvent<
      ArbitratedEvent.InputTuple,
      ArbitratedEvent.OutputTuple,
      ArbitratedEvent.OutputObject
    >;
    Arbitrated: TypedContractEvent<
      ArbitratedEvent.InputTuple,
      ArbitratedEvent.OutputTuple,
      ArbitratedEvent.OutputObject
    >;

    "ArbitratorApproved(uint256,address,uint256)": TypedContractEvent<
      ArbitratorApprovedEvent.InputTuple,
      ArbitratorApprovedEvent.OutputTuple,
      ArbitratorApprovedEvent.OutputObject
    >;
    ...
    "ArbitratorProposed(uint256,address,uint16,address)": TypedContractEvent<
      ArbitratorProposedEvent.InputTuple,
      ArbitratorProposedEvent.OutputTuple,
      ArbitratorProposedEvent.OutputObject
    >;
    ArbitratorProposed: TypedContractEvent<
      ArbitratorProposedEvent.InputTuple,
      ArbitratorProposedEvent.OutputTuple,
      ArbitratorProposedEvent.OutputObject
    >;
