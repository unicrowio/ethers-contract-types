...
export type TokenStructOutput = [
  ...
  decimals: bigint,
  symbol: string
] & { address_: string; decimals: bigint; symbol: string };
...
export interface Unicrow extends BaseContract {
  ...
  sendEscrowShare: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, currency: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getAllEscrowData"
  ): TypedContractMethod<[escrowId: BigNumberish], [DataStructOutput], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "sendEscrowShare"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, currency: AddressLike],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "unicrowDispute"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    "Pay(uint256,uint256,tuple,address,uint256,uint256)": TypedContractEvent<
      PayEvent.InputTuple,
      PayEvent.OutputTuple,
      PayEvent.OutputObject
    >;
    ...
    "Refund(uint256,tuple,uint256)": TypedContractEvent<
      RefundEvent.InputTuple,
      RefundEvent.OutputTuple,
      RefundEvent.OutputObject
    >;
    ...
    "Release(uint256,uint256,tuple,uint256[5])": TypedContractEvent<
      ReleaseEvent.InputTuple,
      ReleaseEvent.OutputTuple,
      ReleaseEvent.OutputObject
    >;
