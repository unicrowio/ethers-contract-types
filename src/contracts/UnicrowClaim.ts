...
export declare namespace UnicrowClaim {
  ...
  ] & { escrowId: bigint; amount: [bigint, bigint, bigint, bigint, bigint] };
}
...
export namespace ClaimEvent {
  export type InputTuple = [escrow: UnicrowClaim.ClaimEventStruct];
  export type OutputTuple = [escrow: UnicrowClaim.ClaimEventStructOutput];
...
export namespace ClaimMultipleEvent {
  export type InputTuple = [escrows: UnicrowClaim.ClaimEventStruct[]];
  export type OutputTuple = [escrows: UnicrowClaim.ClaimEventStructOutput[]];
  export interface OutputObject {
...
export interface UnicrowClaim extends BaseContract {
  ...
  ): TypedContractMethod<[escrows: BigNumberish[]], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "crowRewards"
  ...
  getFunction(
    nameOrSignature: "updateCrowRewards"
  ): TypedContractMethod<[crowRewards_: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "updateProtocolFeeAddress"
  ): TypedContractMethod<
    [protocolFeeAddress_: AddressLike],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "updateStakingRewards"
  ): TypedContractMethod<[stakingRewards_: AddressLike], [void], "nonpayable">;
  ...
  getEvent(
    ...
    ClaimMultipleEvent.InputTuple,
    ClaimMultipleEvent.OutputTuple,
    ClaimMultipleEvent.OutputObject
  >;

  filters: {
    "Claim(tuple)": TypedContractEvent<
      ClaimEvent.InputTuple,
      ClaimEvent.OutputTuple,
      ClaimEvent.OutputObject
    >;
    ...
    "ClaimMultiple(tuple[])": TypedContractEvent<
      ClaimMultipleEvent.InputTuple,
      ClaimMultipleEvent.OutputTuple,
      ClaimMultipleEvent.OutputObject
    >;
    ClaimMultiple: TypedContractEvent<
      ClaimMultipleEvent.InputTuple,
      ClaimMultipleEvent.OutputTuple,
      ClaimMultipleEvent.OutputObject
    >;
