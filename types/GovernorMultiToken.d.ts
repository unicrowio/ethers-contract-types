...
export interface GovernorMultiTokenInterface extends utils.Interface {
    contractName: "GovernorMultiToken";
    functions: {
...
export interface GovernorMultiToken extends BaseContract {
    contractName: "GovernorMultiToken";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GovernorMultiTokenInterface;
