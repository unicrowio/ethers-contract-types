...
export interface CrowRewardsInterface extends utils.Interface {
    contractName: "CrowRewards";
    functions: {
...
export interface CrowRewards extends BaseContract {
    contractName: "CrowRewards";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CrowRewardsInterface;
    ...
    functions: {
        calculateReward(fee: BigNumberish, overrides?: Overrides & {
